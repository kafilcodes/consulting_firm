...
import { createService, uploadServiceImage } from '@/lib/firebase/services';
...
const serviceSchema = z.object({
  ...
  features: z.array(z.string().min(3, 'Feature must be at least 3 characters')),
  requirements: z.array(z.string()),
  deliverables: z.array(z.string().min(3, 'Deliverable must be at least 3 characters')),
  ...
  const onSubmit = async (data: ServiceFormValues) => {
    try {
      ...
      if (imageFile) {
        ...
        await updateService(serviceId, { image: imageUrl });
      }
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Provide the basic details about the service
              </CardDescription>
            </CardHeader>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Set the price and billing details
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Specify what the service includes and what's required
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <div>
